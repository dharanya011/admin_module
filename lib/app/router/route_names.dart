class RouteNames {
  ...
  static const String superAdminRolesPermissions = '/superadmin/roles-permissions';
  static const String superAdminOrganizationManagement = '/superadmin/organization-management';
  static const String superAdminAcademicConfig = '/superadmin/academic-config';
  static const String superAdminModuleManagement = '/superadmin/module-management';
  static const String superAdminSystemSettings = '/superadmin/system-settings';
  static const String superAdminNotificationManagement = '/superadmin/notification-management';
  static const String superAdminDatabaseManager = '/superadmin/database-manager';
  static const String superAdminBackupRestore = '/superadmin/backup-restore';
  static const String superAdminStorageManagement = '/superadmin/storage-management';
  ...
  static const String superAdminErrorMonitoring = '/superadmin/error-monitoring';
  static const String superAdminAuditLogs = '/superadmin/audit-logs';
  static const String superAdminLicenseSubscription = '/superadmin/license-subscription';
  static const String superAdminAnalyticsDashboard = '/superadmin/analytics-dashboard';
  static const String superAdminDigitalRepository = '/superadmin/digital-repository';
  static const String superAdminProfile = '/superadmin/profile';

  // Legacy route aliases for super admin
  static const String superAdminSmsEmailConfig = superAdminNotificationManagement;
  static const String superAdminNotificationConfig = superAdminNotificationManagement;
  static const String superAdminSecurityAudit = superAdminAuditLogs;
  static const String superAdminUserConsole = superAdminUsers;
  static const String superAdminCommunicationGateway = superAdminNotificationManagement;
  ...
  static const String academicYear = '/admin/academic-year'; // 2. Academic Year Management
  static const String departments = '/admin/departments'; // 3. Department Management
  static const String programmesSubjects = '/admin/programmes-subjects'; // 4. Programme & Subject Management
  static const String regulations = '/admin/regulations'; // 5. Regulation Management
  static const String academicConfig = '/admin/academic-config'; // 6. Academic Configuration
  ...
  static const String attendance = '/admin/attendance'; // 11. Attendance Management
  static const String marks = '/admin/marks'; // 12. Marks Management
  static const String examinations = '/admin/examinations'; // 13. Examination Management
  static const String hallTicket = '/admin/hall-ticket'; // 14. Hall Ticket Management
  static const String results = '/admin/results'; // 15. Results Management
  static const String certificates = '/admin/certificates'; // 16. Certificates Management

  // 5. Finance & HR
  static const String feesScholarships = '/admin/fees-scholarships'; // 17. Fees & Scholarships
  static const String hr = '/admin/hr'; // 18. HR & Payroll
  static const String medicalManagement = '/admin/medical'; // 30. Medical Management (renamed)

  // 6. Campus Services
  static const String library = '/admin/library'; // 19. Library Management
  static const String hostel = '/admin/hostel'; // 20. Hostel Management
  static const String transport = '/admin/transport'; // 21. Transport Management
  static const String placement = '/admin/placement'; // 22. Placement & Training
  static const String eventManagement = '/admin/events'; // 23. Event Management
  ...
  // 9. Security
  static const String rolesPermissions = '/admin/roles-permissions'; // 26. Roles & Permissions
  static const String auditLogs = '/admin/audit-logs'; // 27. Audit Logs
  static const String backupRestore = '/admin/backup-restore'; // 28. Backup & Restore
  static const String approvalWorkflow = '/admin/approvals'; // 32. Approval Workflow [⭐ New]

  // 10. Settings & Profile
  static const String systemSettings = '/admin/system-settings'; // 29. System Settings
